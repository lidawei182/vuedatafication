<template>
  <div class="slide-verify-container">
    <div class="slide-verify-block-box"></div>
    <div class="slide-verify" :style="{ 'width': w }" id="slideVerify" onselectstart="return false;">
      <img :src="photos" class="photos-img" />
      ...
      <!-- container -->
      <div class="slide-verify-slider" :style="{ 'width': w }"
...
export default {
  ...
  data() {
    return {
      photos: require("../../../assets/photos.gif"),
  ...
  methods: {
    ...
    createImg(onload) {
      ...
      img.onload = onload;
      img.onerror = () => {
        img.src = this.getRandomImgError();
      };
    ...
    // 随机生成img src
    getRandomImg() {
      return require("../../../assets/img" + this.getRandomNumberByRange(0, 3)+".jpg");
    },
    getRandomImgError() {
