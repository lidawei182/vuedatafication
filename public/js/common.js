...
CalendarInline.prototype.ready = function(e) {
	...
	var t = e.currentTarget,
		o = document.querySelector(t.getAttribute("href"));
	...
	var t = e.querySelector(".switcher-date__input"),
		o = document.querySelector(".calendar-toolbox__month"),
		r = e.querySelector(".js-input-select"),
		n = document.querySelectorAll(".switcher-date__btn");
	if(t) {
		var i = r.options.length,
			a = r.options.selectedIndex,
			s = !1,
			c = function(e) {
				setTimeout(function() {
					o.classList.add(e)
...
function form() {
	var e = new Date,
		...
		o = (e.getDate().toString(), e.getMonth().toString()),
...
Echart.prototype.init = function(e) {
	...
	return {
		...
		position: function(e, t, o, r, n) {
			var i = e[1] <= n.contentSize[1] + 30 ? 40 : e[1] - n.contentSize[1] - 10,
				a = n.viewSize[0] - e[0] <= n.contentSize[0] / 2,
				s = e[0] <= n.contentSize[0] / 2;
			return a ? {
				right: 0,
				top: i
			} : s ? {
...
}, Chat.search = function() {}, HeaderSearch.prototype.toggle = function(e) {
	var t = this;
	e.preventDefault();
	...
	var o = t,
		r = o.closest(".image-upload").querySelector(".image-upload__list"),
	...
	var o = e.target,
		...
		n = o.parentNode,
		i = r.querySelectorAll(".image-upload__item");
	...
	var t = e.currentTarget,
		o = e.target.files || e.dataTransfer.files,
		r = t.querySelector(".profile-upload__image");
...
}, Inbox.search = function() {}, Modal.prototype.events = function() {
	...
	this.element.forEach(function(e) {
		var t = e,
			o = document.querySelectorAll('[data-checkbox="'.concat(t.getAttribute("data-checkbox-all"), '"]'));
	...
	var t = e.currentTarget,
		...
		r = document.querySelectorAll('[data-checkbox="'.concat(o.getAttribute("data-checkbox-all"), '"]')),
		n = [];
	...
	this.floatElement.forEach(function(e) {
		var t = e,
			o = t.closest(".switcher-button").querySelector(".active");
		SwitcherGroup.getWidth(t, o)
	})
}, SwitcherGroup.prototype.toggle = function(e) {
	var t = e.target,
		o = t.closest(".switcher-button"),
		r = o.querySelector(".switcher-button__float");
	...
	var t = e.currentTarget,
		o = t.closest(".pagination").querySelector(".active");
...
var isTouchDevices = "ontouchstart" in window || window.DocumentTouch && document instanceof window.DocumentTouch,
	...
	triggerEvent = function(e, t) {
		...
		"click" === e && (o = new MouseEvent("click", {
			bubbles: r,
			cancelable: !0,
			view: window
		}));
	...
	themeStyle = function(e, t) {
		var o = !(2 < arguments.length && void 0 !== arguments[2]) || arguments[2],
			r = document.querySelector("html").getAttribute("data-theme"),
			n = function(e) {
...
$((isTouchDevices && document.querySelector("html").classList.add("is-touch"), imgLoaded.on("always", function() {
	...
	e.addEventListener("click", function(e) {
		var t = e.currentTarget,
			o = document.querySelector('[href="'.concat(t.getAttribute("data-toggle-tab"), '"]'));
